...
import { EmergencyContact } from '../../../../models/Iforms/emergency-contact';
@Component({
  selector: 'renew-app-emergency-details',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule],
  templateUrl: './emergency-details.component.html',
  styleUrls: ['./emergency-details.component.css'],
})
export class RenewEmergencyDetailsComponent implements OnInit {
