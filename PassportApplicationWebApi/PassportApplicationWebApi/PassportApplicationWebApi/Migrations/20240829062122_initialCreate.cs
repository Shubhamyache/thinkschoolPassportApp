...
namespace PassportApplicationWebApi.Migrations
{
    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RenewalPassportApplications",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    AddressDetailsId = table.Column<int>(type: "int", nullable: false),
                    EmergencyContactDetailsId = table.Column<int>(type: "int", nullable: false),
                    PreviousPassportDetailsId = table.Column<int>(type: "int", nullable: false),
                    DocumentsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RenewalPassportApplications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RenewalPassportApplications_AddressDetails_AddressDetailsId",
                        column: x => x.AddressDetailsId,
                        principalTable: "AddressDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RenewalPassportApplications_ApplicantsDetails_ApplicantDetailsId",
                        column: x => x.ApplicantDetailsId,
                        principalTable: "ApplicantsDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RenewalPassportApplications_Documents_DocumentsId",
                        column: x => x.DocumentsId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RenewalPassportApplications_EmergencyContactDetails_EmergencyContactDetailsId",
                        column: x => x.EmergencyContactDetailsId,
                        principalTable: "EmergencyContactDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RenewalPassportApplications_FamilyDetails_FamilyDetailsId",
                        column: x => x.FamilyDetailsId,
                        principalTable: "FamilyDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RenewalPassportApplications_Passports_PreviousPassportDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_NewPassportApplicationId",
                table: "Users",
                column: "NewPassportApplicationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Users_RenewalApplicationId",
                table: "Users",
                column: "RenewalApplicationId",
                unique: true,
                filter: "[RenewalApplicationId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RenewalPassportApplications_AddressDetailsId",
                table: "RenewalPassportApplications",
                column: "AddressDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_RenewalPassportApplications_ApplicantDetailsId",
                table: "RenewalPassportApplications",
                column: "ApplicantDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_RenewalPassportApplications_DocumentsId",
                table: "RenewalPassportApplications",
                column: "DocumentsId");

            migrationBuilder.CreateIndex(
                name: "IX_RenewalPassportApplications_EmergencyContactDetailsId",
                table: "RenewalPassportApplications",
                column: "EmergencyContactDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_RenewalPassportApplications_FamilyDetailsId",
                table: "RenewalPassportApplications",
                column: "FamilyDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_RenewalPassportApplications_PreviousPassportDetailsId",
                table: "RenewalPassportApplications",
                column: "PreviousPassportDetailsId");

            migrationBuilder.AddForeignKey(
                name: "FK_Users_PassportApplications_NewPassportApplicationId",
                table: "Users",
                column: "NewPassportApplicationId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Users_RenewalPassportApplications_RenewalApplicationId",
                table: "Users",
                column: "RenewalApplicationId",
                principalTable: "RenewalPassportApplications",
                principalColumn: "Id");
        }
